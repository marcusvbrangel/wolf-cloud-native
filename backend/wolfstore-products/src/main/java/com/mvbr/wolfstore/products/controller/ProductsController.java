package com.mvbr.wolfstore.products.controller;

import com.mvbr.wolfstore.products.dto.ProductResponse;
...
@CrossOrigin("http://10.107.134.242:8090/")
public class ProductsController {
    ...
    public String initialPage() {
        return "Welcome the Wolf Store Products API!";
    }
